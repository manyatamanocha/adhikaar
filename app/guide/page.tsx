/**
 * The RBI-cited succession-certificate guide.
 *
 * Moved here from "/" on 4 Sep 2026: "/" became the search-first
 * "find unclaimed money" surface (RecoverPage, formerly at /recover), and
 * this page -- the actual paragraph-cited guidance on nominee, survivorship
 * and no-certificate claims -- moved to its own route rather than being
 * discarded. It's the page Situations, GuidedClaim and the search flow all
 * eventually point a visitor toward once there's something real to claim.
 *
 * Everything below this comment is unchanged from the former "/": same
 * content, same legal-accuracy history, only the header's `path` prop moved
 * to "/guide" so the language switcher stays on this page.
 *
...
import { HomeLocaleProvider } from "../recover/_components/home-i18n";
...
export default async function Guide({
  ...
  return (
    <HomeLocaleProvider locale={lang}>
      <RecoverNav locale={lang} />
