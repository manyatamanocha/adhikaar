...
const en: HomeDict = {
  ...
  startPage: {
    ...
    questionOf: (current, total) => `Step ${current} of up to ${total}`,
...
const hi: HomeDict = {
  ...
  startPage: {
    ...
    questionOf: (current, total) => `अधिकतम ${total} में से चरण ${current}`,
...
const kn: HomeDict = {
  ...
  startPage: {
    ...
    questionOf: (current, total) => `ಗರಿಷ್ಠ ${total} ರಲ್ಲಿ ಹಂತ ${current}`,
