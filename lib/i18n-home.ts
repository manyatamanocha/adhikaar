...
export type HomeDict = {
  ...
  startPage: {
     ...
     * shortened bar reads as their journey narrowing rather than the scale
     * moving. `lastQuestion` replaces it on the final screen, where naming
     * the count is less useful than naming the end.
     */
    questionsRuledOut: (n: number) => string;
    lastQuestion: string;
    timeEstimate: string;
...
const en: HomeDict = {
  ...
  stepsCards: {
    ...
    step2Cta: "Start the Claim Process",
    step3Label: "Step 3",
  ...
  privacyPage: {
    ...
    deviceSectionBody: "The optional deadline tracker saves its date in your browser's local storage. Clear the tracker or the site's browser data to remove it. Printing, downloading or emailing a guide create copies under your control; Adhikaar cannot delete copies you have shared. Emailing one sends the address you type to Brevo, the service that delivers the message, for that single send -- it is not written to Adhikaar's database, and the attached guide is generated fresh from the page you were reading.",
    analyticsSectionHeading: "Usage analytics",
    analyticsSectionBody: "Basic events such as a question being answered, the outcome reached, a checklist interaction or a print action are sent to Adhikaar's own server and stored there -- never to a third party. A random identifier is generated per visit; since 9 Sep 2026 it is also saved in your browser's local storage, so a return visit can be counted as the same person rather than a new one, purely for a total-visitor count. No analytics cookie, no automatic page views, no session recording. Clearing your browser's site data resets it. This is not a promise that no data reaches a server: the request itself has to reach this site's own server to be answered at all.",
...
const hi: HomeDict = {
  ...
  stepsCards: {
    ...
    step2Cta: "दावा प्रक्रिया शुरू करें",
    step3Label: "चरण 3",
  ...
  privacyPage: {
    ...
    deviceSectionBody: "वैकल्पिक डेडलाइन ट्रैकर अपनी तारीख़ आपके ब्राउज़र के लोकल स्टोरेज में सहेजता है। इसे हटाने के लिए ट्रैकर या साइट का ब्राउज़र डेटा साफ़ करें। गाइड छापने, डाउनलोड करने या ईमेल करने से आपके नियंत्रण में प्रतियाँ बनती हैं; आपने साझा की गई प्रतियों को अधिकार मिटा नहीं सकता। ईमेल करने पर आपने जो पता लिखा है वह केवल उसी एक संदेश को पहुँचाने के लिए Brevo सेवा को भेजा जाता है -- वह अधिकार के डेटाबेस में दर्ज नहीं होता, और गाइड उसी पेज से नए सिरे से बनाई जाती है जिसे आप पढ़ रहे थे।",
    analyticsSectionHeading: "उपयोग विश्लेषण",
    analyticsSectionBody: "किसी सवाल का जवाब देना, पहुँचा गया नतीजा, सूची से जुड़ी कार्रवाई या प्रिंट करना जैसी कुछ बुनियादी घटनाएँ अधिकार के अपने सर्वर को भेजी जाती हैं और वहीं सुरक्षित रहती हैं -- किसी तीसरे पक्ष को कभी नहीं। हर विज़िट के लिए एक रैंडम पहचानकर्ता बनाया जाता है; 9 सितंबर 2026 से यह आपके ब्राउज़र के लोकल स्टोरेज में भी सहेजा जाता है, ताकि दोबारा आने पर उसे नया नहीं बल्कि वही व्यक्ति माना जा सके -- केवल कुल विज़िटर गिनती के लिए। कोई विश्लेषण कुकी नहीं, कोई स्वचालित पेज-व्यू नहीं, कोई सेशन रिकॉर्डिंग नहीं। अपने ब्राउज़र का साइट डेटा साफ़ करने से यह रीसेट हो जाता है। यह वादा नहीं है कि कोई डेटा सर्वर तक नहीं पहुँचता: अनुरोध का जवाब देने के लिए उसे इस साइट के अपने सर्वर तक पहुँचना ही पड़ता है।",
...
const kn: HomeDict = {
  ...
  stepsCards: {
    ...
    step2Cta: "ಹಕ್ಕಿನ ಪ್ರಕ್ರಿಯೆ ಪ್ರಾರಂಭಿಸಿ",
    step3Label: "ಹಂತ 3",
  ...
  privacyPage: {
    ...
    deviceSectionBody: "ಐಚ್ಛಿಕ ಗಡುವು ಟ್ರ್ಯಾಕರ್ ತನ್ನ ದಿನಾಂಕವನ್ನು ನಿಮ್ಮ ಬ್ರೌಸರ್‌ನ ಲೋಕಲ್ ಸ್ಟೋರೇಜ್‌ನಲ್ಲಿ ಉಳಿಸುತ್ತದೆ. ಇದನ್ನು ತೆಗೆದುಹಾಕಲು ಟ್ರ್ಯಾಕರ್ ಅಥವಾ ಸೈಟಿನ ಬ್ರೌಸರ್ ಡೇಟಾ ತೆರವುಗೊಳಿಸಿ. ಗೈಡ್ ಅನ್ನು ಮುದ್ರಿಸುವುದು, ಡೌನ್‌ಲೋಡ್ ಮಾಡುವುದು ಅಥವಾ ಇಮೇಲ್ ಮಾಡುವುದು ನಿಮ್ಮ ನಿಯಂತ್ರಣದಲ್ಲಿ ಪ್ರತಿಗಳನ್ನು ರಚಿಸುತ್ತದೆ; ನೀವು ಹಂಚಿಕೊಂಡ ಪ್ರತಿಗಳನ್ನು ಅಧಿಕಾರ್ ಅಳಿಸಲಾಗುವುದಿಲ್ಲ. ಇಮೇಲ್ ಮಾಡಿದಾಗ ನೀವು ಬರೆದ ವಿಳಾಸವನ್ನು ಆ ಒಂದು ಸಂದೇಶ ತಲುಪಿಸಲು ಮಾತ್ರ Brevo ಸೇವೆಗೆ ಕಳುಹಿಸಲಾಗುತ್ತದೆ -- ಅದು ಅಧಿಕಾರ್‌ನ ಡೇಟಾಬೇಸ್‌ನಲ್ಲಿ ದಾಖಲಾಗುವುದಿಲ್ಲ, ಮತ್ತು ಗೈಡ್ ಅನ್ನು ನೀವು ಓದುತ್ತಿದ್ದ ಪುಟದಿಂದಲೇ ಹೊಸದಾಗಿ ರಚಿಸಲಾಗುತ್ತದೆ.",
    analyticsSectionHeading: "ಬಳಕೆಯ ವಿಶ್ಲೇಷಣೆ",
    analyticsSectionBody: "ಪ್ರಶ್ನೆಗೆ ಉತ್ತರಿಸುವುದು, ತಲುಪಿದ ಫಲಿತಾಂಶ, ಪಟ್ಟಿಯ ಕ್ರಿಯೆ ಅಥವಾ ಮುದ್ರಣ ಕ್ರಿಯೆಯಂತಹ ಮೂಲಭೂತ ಘಟನೆಗಳನ್ನು ಅಧಿಕಾರ್‌ನ ಸ್ವಂತ ಸರ್ವರ್‌ಗೆ ಕಳುಹಿಸಿ ಅಲ್ಲಿಯೇ ಸಂಗ್ರಹಿಸಲಾಗುತ್ತದೆ -- ಎಂದಿಗೂ ಯಾವುದೇ ಮೂರನೇ ವ್ಯಕ್ತಿಗೆ ಅಲ್ಲ. ಪ್ರತಿ ಭೇಟಿಗೆ ಒಂದು ಯಾದೃಚ್ಛಿಕ ಗುರುತಿಸುವಿಕೆ ರಚಿಸಲಾಗುತ್ತದೆ; 9 ಸೆಪ್ಟೆಂಬರ್ 2026 ರಿಂದ ಅದನ್ನು ನಿಮ್ಮ ಬ್ರೌಸರ್‌ನ ಲೋಕಲ್ ಸ್ಟೋರೇಜ್‌ನಲ್ಲಿಯೂ ಉಳಿಸಲಾಗುತ್ತದೆ, ಇದರಿಂದ ಮರುಭೇಟಿಯನ್ನು ಹೊಸಬರಂತೆ ಅಲ್ಲ, ಅದೇ ವ್ಯಕ್ತಿಯಂತೆ ಎಣಿಸಬಹುದು -- ಕೇವಲ ಒಟ್ಟು ಭೇಟಿಗಾರರ ಎಣಿಕೆಗಾಗಿ. ಯಾವುದೇ ವಿಶ್ಲೇಷಣೆ ಕುಕೀ ಇಲ್ಲ, ಯಾವುದೇ ಸ್ವಯಂಚಾಲಿತ ಪುಟ-ವೀಕ್ಷಣೆ ಇಲ್ಲ, ಯಾವುದೇ ಸೆಷನ್ ರೆಕಾರ್ಡಿಂಗ್ ಇಲ್ಲ. ನಿಮ್ಮ ಬ್ರೌಸರ್‌ನ ಸೈಟ್ ಡೇಟಾ ತೆರವುಗೊಳಿಸುವುದರಿಂದ ಇದು ಮರುಹೊಂದಿಸಲ್ಪಡುತ್ತದೆ. ಯಾವುದೇ ಡೇಟಾ ಸರ್ವರ್‌ಗೆ ತಲುಪುವುದಿಲ್ಲ ಎಂಬ ಭರವಸೆ ಇದಲ್ಲ: ವಿನಂತಿಗೆ ಉತ್ತರಿಸಲು ಅದು ಈ ಸೈಟ್‌ನ ಸ್ವಂತ ಸರ್ವರ್‌ಗೆ ತಲುಪಲೇಬೇಕು.",
